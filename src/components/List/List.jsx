    ...
    <>
      {listItems.map((item, index) => (
        ...
        >
          ...
          />
          <p className="absolute left-0 top-[24px] right-0 font-sans text-xl text-white font-bold px-4 text-center leading-6">
            {item.title}
          </p>
          <p className="absolute left-0 right-0 bottom-[85px] font-sans text-md text-white px-4 text-center leading-4">
            {item.description}
          </p>
